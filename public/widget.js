(() => {
  ...
  root.id = "openrouter-double-widget";
  root.innerHTML = `
    <style>
      #openrouter-double-widget * { box-sizing: border-box; }
      #openrouter-double-widget .ddw-button {
      ...
      #openrouter-double-widget .ddw-panel {
      ...
      #openrouter-double-widget .ddw-panel.open { display: flex; flex-direction: column; }
      #openrouter-double-widget .ddw-head { padding: 16px; background: #2457ff; color: white; }
      #openrouter-double-widget .ddw-head strong { display: block; font-size: 16px; }
      #openrouter-double-widget .ddw-head span { opacity: .88; font-size: 13px; }
      #openrouter-double-widget .ddw-messages { flex: 1; overflow-y: auto; padding: 14px; background: #f8fafc; }
      #openrouter-double-widget .ddw-msg { padding: 10px 12px; border-radius: 16px; margin-bottom: 10px; line-height: 1.42; white-space: pre-wrap; font-size: 14px; }
      #openrouter-double-widget .ddw-bot { background: white; color: #172033; }
      #openrouter-double-widget .ddw-user { background: #2457ff; color: white; margin-left: 42px; }
      #openrouter-double-widget .ddw-form { display: flex; gap: 8px; padding: 10px; border-top: 1px solid #e2e8f0; }
      #openrouter-double-widget textarea { flex: 1; resize: none; border: 1px solid #cbd5e1; border-radius: 14px; padding: 10px; font: inherit; font-size: 14px; outline: none; }
      #openrouter-double-widget .ddw-send { border: 0; border-radius: 14px; background: #2457ff; color: white; padding: 0 12px; font-weight: 700; cursor: pointer; }
      @media (max-width: 520px) {
        #openrouter-double-widget .ddw-panel { right: 12px; bottom: 88px; }
        #openrouter-double-widget .ddw-button { right: 14px; bottom: 14px; }
      }
    </style>
